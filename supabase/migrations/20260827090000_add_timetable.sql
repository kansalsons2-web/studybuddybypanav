-- Weekly timetable: a recurring template of study blocks (day_of_week +
-- start/end time), plus a per-date completion log so the same slot can be
-- marked "followed" or "missed" on any given calendar date.
